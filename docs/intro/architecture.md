...
Learn how Impactchain's architecture leverages the Cosmos SDK Proof-of-Stake functionality, EVM compatibility and fast-finality from Tendermint Core's BFT consensus. {synopsis}
...
engines of other blockchains. Impactchain is such an example of an ABCI application
...
Check the available Impactchain [resources](./resources.md) {hide}
