<template lang="pug">
  div
    ...
    .h2 Getting Started
    .p__alt Read all about Impactchain or dive straight into the code with guides.
    .features
      ...
      router-link(to="/guides").features__item.features__item__dark
        ...
        .features__item__text
          ...
          .features__item__text__p Follow guides to using polular Ethereum tools with Impactchain.
    .sections__wrapper
      .h2 Explore Impactchain
      .p__alt Get familiar with Impactchain and explore its main concepts.
      .sections
    ...
    .p__alt Check out the docs for the various parts of the Impactchain stack.
    .stack
