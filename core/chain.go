...
// transactions. There should only be a single implementation in Impactchain. For
// the purposes of Impactchain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: Impactchain will distribute the fees out to validators, so the structure
