...
// Implemented by ImpactchainBackend.
...
var _ Backend = (*ImpactchainBackend)(nil)

// ImpactchainBackend implements the Backend interface
type ImpactchainBackend struct {
	ctx       context.Context
...
// New creates a new ImpactchainBackend instance
func New(clientCtx clientcontext.CLIContext) *ImpactchainBackend {
	return &ImpactchainBackend{
...
func (b *ImpactchainBackend) BlockNumber() (hexutil.Uint64, error) {
...
func (b *ImpactchainBackend) GetBlockByNumber(blockNum rpctypes.BlockNumber, fullTx bool) (map[string]interface{}, error) {
...
func (b *ImpactchainBackend) GetBlockByHash(hash common.Hash, fullTx bool) (map[string]interface{}, error) {
...
func (b *ImpactchainBackend) HeaderByNumber(blockNum rpctypes.BlockNumber) (*ethtypes.Header, error) {
	height := blockNum.Int64()
	if height <= 0 {
		// get latest block height
		num, err := b.BlockNumber()
...
func (b *ImpactchainBackend) HeaderByHash(blockHash common.Hash) (*ethtypes.Header, error) {
...
func (b *ImpactchainBackend) GetTransactionLogs(txHash common.Hash) ([]*ethtypes.Log, error) {
...
func (b *ImpactchainBackend) PendingTransactions() ([]*rpctypes.Transaction, error) {
	...
	for _, tx := range pendingTxs.Txs {
		...
		if err != nil {
			// ignore non Impactchain EVM transactions
			continue
		}
...
func (b *ImpactchainBackend) GetLogs(blockHash common.Hash) ([][]*ethtypes.Log, error) {
	res, _, err := b.clientCtx.Query(fmt.Sprintf("custom/%s/%s/%s", evmtypes.ModuleName, evmtypes.QueryHashToHeight, blockHash.Hex()))
	if err != nil {
		return nil, err
	}
...
func (b *ImpactchainBackend) BloomStatus() (uint64, uint64) {
	return 4096, 0
}

// LatestBlockNumber gets the latest block height in int64 format.
func (b *ImpactchainBackend) LatestBlockNumber() (int64, error) {
